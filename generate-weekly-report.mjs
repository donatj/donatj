...
If you find relevant public technical writing or discussion by ${username} from the period—on the personal blog (https://donatstudios.com/), X (https://x.com/donatj), Bluesky (https://bsky.app/profile/donatstudios.com), or other public social media—add a brief final section titled "What I have been thinking about". Summarize the general ideas without linking to social-media posts. Omit the section entirely if there is no relevant material. Do not include personal information or private details.

Write a concise, friendly, human-readable Markdown update for ${username}'s GitHub profile README in 2–3 short paragraphs. Write entirely in the first person. Give a human overview of what I am working on and, when the sources support it, why the work matters or what it aims to accomplish. Use the tone of catching up an old friend on what I have been working on. Links should support the story, never become a list of activity. Use bullets only when they materially improve clarity. Do not include calendar dates or date ranges in the report. Be factual; do not invent work or claim private information. Return only the update, beginning with this exact heading:\n\n${heading}`,
	text: { verbosity: "low" },
});
