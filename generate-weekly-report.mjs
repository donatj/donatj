...
For an optional final section, use the additional context appended below and, if useful, the personal blog (https://donatstudios.com/), X (https://x.com/donatj), Bluesky (https://bsky.app/profile/donatstudios.com), or other public social media. If these sources contain relevant non-political thoughts about technology, software, or how technology affects work, everyday life, or the wider world, put them exclusively in a final Markdown section with this exact heading: "#### What I have been thinking about". Do not mention these thoughts anywhere else in the report. Do not omit the section merely because the source is a comment rather than a post. Summarize the general ideas without linking to social-media posts. Omit the section entirely only when none of these sources contain relevant material. Do not include personal information or private details.

Write a concise, friendly, human-readable Markdown update for ${username}'s GitHub profile README. Write entirely in the first person and use the tone of catching up an old friend on what I have been working on. Before any optional thoughts section, write exactly three short prose paragraphs: lead with new projects when any exist, then cover the most important recent active work, then add only context that helps explain the overall direction of the work.
